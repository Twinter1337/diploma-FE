...
const STEP_LABELS: string[] = ['Основна інформація', 'Параметри'];
...
export default function OnboardingPage() {
  ...
  const {
    step1, step2,
    setStep1, setStep2,
    disabilityTags, tagsLoading, tagsError, retryTags,
    isLoading, error, clearError,
    uploadAvatar, isUploadingAvatar, uploadAvatarError,
    submitStep1, submitStep2,
  } = useOnboarding();
  ...
  const handleStep2Next = async () => {
    ...
    if (ok) navigate('/search', { state: { city: step1.city } });
  };
